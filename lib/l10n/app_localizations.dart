...
abstract class AppLocalizations {
  ...
  /// No description provided for @institutionCity.
  ///
  /// In fr, this message translates to:
  /// **'Ville'**
  String get institutionCity;
  ...
  /// No description provided for @institutionStatusPending.
  ///
  /// In fr, this message translates to:
  /// **'En attente de validation'**
  String get institutionStatusPending;

  /// No description provided for @institutionStatusApproved.
  ///
  /// In fr, this message translates to:
  /// **'Validé'**
  String get institutionStatusApproved;

  /// No description provided for @institutionStatusRejected.
  ///
  /// In fr, this message translates to:
  /// **'Rejeté'**
  String get institutionStatusRejected;

  /// No description provided for @institutionSaved.
  ///
  /// In fr, this message translates to:
