...
const InstitutionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _InstitutionstatusEnumValueMap,
    )
  },
...
Institution _institutionDeserialize(
  ...
  final object = Institution(
    ...
    status: _InstitutionstatusValueEnumMap[reader.readByteOrNull(offsets[4])] ??
        InstitutionValidationStatus.pendingValidation,
  );
...
P _institutionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readString(offset)) as P;
    case 4:
      return (_InstitutionstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          InstitutionValidationStatus.pendingValidation) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _InstitutionstatusEnumValueMap = {
  'pendingValidation': 0,
  'approved': 1,
  'rejected': 2,
};
const _InstitutionstatusValueEnumMap = {
  0: InstitutionValidationStatus.pendingValidation,
  1: InstitutionValidationStatus.approved,
  2: InstitutionValidationStatus.rejected,
};
...
extension InstitutionQueryFilter
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityEqualTo(
    String value, {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> cityIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'city',
        value: '',
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> statusEqualTo(
      InstitutionValidationStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: value,
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> statusLessThan(
    InstitutionValidationStatus value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QAfterFilterCondition> statusBetween(
    InstitutionValidationStatus lower,
    InstitutionValidationStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension InstitutionQuerySortBy
  ...
  QueryBuilder<Institution, Institution, QAfterSortBy> sortByCity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'city', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> sortByCityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'city', Sort.desc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> sortByCreatedByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdByUserId', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy>
  ...
  QueryBuilder<Institution, Institution, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension InstitutionQuerySortThenBy
  ...
  QueryBuilder<Institution, Institution, QAfterSortBy> thenByCity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'city', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> thenByCityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'city', Sort.desc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> thenByCreatedByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdByUserId', Sort.asc);
    });
  }
  ...
  QueryBuilder<Institution, Institution, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Institution, Institution, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension InstitutionQueryWhereDistinct
  ...
  QueryBuilder<Institution, Institution, QDistinct> distinctByCity(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createdAt');
    });
  }

  QueryBuilder<Institution, Institution, QDistinct> distinctByCreatedByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Institution, Institution, QDistinct> distinctByStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension InstitutionQueryProperty
  ...
  QueryBuilder<Institution, String, QQueryOperations> cityProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'city');
    });
  }

  QueryBuilder<Institution, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<Institution, String, QQueryOperations>
  ...
  QueryBuilder<Institution, InstitutionValidationStatus, QQueryOperations>
      statusProperty() {
    return QueryBuilder.apply(this, (query) {
